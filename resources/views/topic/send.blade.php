...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <strong>Send to topic</strong> No. {{ $topic->id }}
        </div>
        <div class="card-body card-block">
            <form action="{{ route("topic.storeNotification", $topic->id) }}" method="post" class="form-horizontal", enctype="multipart/form-data">
                @if($errors->any())
                ...
                <div class="row form-group">
                    ...
                    <div class="col col-md-9">
                        <select class="form-control" name="messages">
                            <option value="{{ null }}" select>Without Template</option>
