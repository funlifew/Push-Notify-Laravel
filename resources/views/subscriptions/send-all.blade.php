...
@section('title', 'Send to All Subscriptions')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Send to All Subscriptions</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('notify.dashboard') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-md-8 mx-auto">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent">
                <h5 class="mb-0">
                    <i class="bi bi-broadcast"></i> Send to All Subscribers
                    <span class="badge bg-primary ms-2">{{ \Funlifew\PushNotify\Models\Subscription::count() }} subscribers</span>
                </h5>
            </div>
            <div class="card-body">
                <div class="alert alert-info">
                    <i class="bi bi-info-circle"></i> This will send a notification to all active subscribers.
                </div>
                
                <form action="{{ route('notify.subscriptions.send-all.post') }}" method="POST" enctype="multipart/form-data">
                    @csrf
